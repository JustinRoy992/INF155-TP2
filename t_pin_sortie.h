...
//Cette redéclaration de type est nécessaire au cas où ce fichier est compilé AVANT "t_pin_entree.h"
...
/*
Fonction: PIN_SORTIE_INIT (constructeur)
...
/*
Fonction: PIN_SORTIE_DESTROY (Destructeur)
...
/*
Fonction: PIN_SORTIE_GET_VALEUR (Accesseur)
...
/*
Fonction: PIN_SORTIE_SET_VALEUR (Mutateur)
...
/*
Fonction: PIN_SORTIE_AJOUTER_LIEN
Description: Relie le pin de sortie à un pin d'entrée. Cette fonction permet de relier le composant, 
			 auquel apparatien le pin de sortie, à un autre composant, auquel appartient 
			 le pin d'entrée.
...
/*
Fonction: PIN_SORTIE_SUPPRIMER_LIEN
...
/*
Fonction: PIN_SORTIE_EST_RELIEE
...
/*
Fonction: PIN_SORTIE_PROPAGER_SIGNAL
